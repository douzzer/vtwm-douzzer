...
extern MenuItem *AddToMenu(MenuRoot * menu, char *item, char *action, char *action2, char *action3, MenuRoot * sub, int func, char *fore, char *back);
extern int PopUpMenu(MenuRoot * menu, int x, int y, int center);
extern MenuRoot *FindMenuRoot(char *name);
extern int AddFuncKey(char *name, int cont, int mods, int func, char *win_name, char *action, char *action2, char *action3);
extern int ExecuteFunction(int func, char *action, char *action2, char *action3, Window w, TwmWindow * tmp_win, XEvent * eventp, int context, int pulldown);
...
extern void PaintEntry(MenuRoot * mr, MenuItem * mi, int exposure);
extern void SetBorder(TwmWindow * tmp, int onoroff);
extern int CreateTitleButton(char *name, int func, char *action, char *action2, char *action3, MenuRoot * menuroot, int rightside, int append);
